...
export const PASSENGER_ROUTE_MAP = {
    ...
    'STARTED': '/ride/:id',
    'IN_PROGRESS': '/ride/:id',
    'COMPLETED': '/home' // Change this to actual payment route if exists
};
...
export const resolveRouteFromState = (rideStatus, role, rideId) => {
    ...
    // Add default fallback to /pickup if status is unmapped but we have a rideId (for driver)
    // Add default fallback to /ride/:id if status is unmapped for passenger
