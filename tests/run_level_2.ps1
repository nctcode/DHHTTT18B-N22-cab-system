...
Write-Host "   BAT DAU CHAY TEST LEVEL 2               " -ForegroundColor Cyan
Write-Host "   (Validation & Edge Cases)               " -ForegroundColor Cyan
Write-Host "==========================================" -ForegroundColor Cyan
...
# Chay test
Write-Host ""
Write-Host "Dang thuc thi cac test cases (TC11-TC20)..." -ForegroundColor Yellow
$env:TEST_BASE_URL = "http://localhost:3000"
npx jest level_2_adaptive.test.js --verbose --forceExit --detectOpenHandles

if ($LASTEXITCODE -eq 0) {
    Write-Host ""
    Write-Host "==========================================" -ForegroundColor Green
    Write-Host "   TAT CA LEVEL 2 TEST CASES DA PASS!      " -ForegroundColor Green
    Write-Host "==========================================" -ForegroundColor Green
} else {
    Write-Host ""
